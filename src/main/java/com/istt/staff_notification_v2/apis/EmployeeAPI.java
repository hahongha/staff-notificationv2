...
//	 @PreAuthorize("hasRole('ROLE_ADMIN')")
	...
	public ResponseDTO<EmployeeDTO> calCountOfDayOff(@RequestBody @Valid EmployeeDTO employeeDTO) throws URISyntaxException {
		if (employeeDTO.getEmail() == null || employeeDTO.getFullname() == null
				|| employeeDTO.getDepartment() == null) {
			throw new BadRequestAlertException("Bad request: missing data", ENTITY_NAME, "missing");
		}
	...
	public ResponseDTO<List<EmployeeDTO>> saveCountOfDayOffs(@RequestBody @Valid List<String> ids) throws URISyntaxException {
